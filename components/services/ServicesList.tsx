"use client"
import { Droplets, Sun, Zap, Mountain, Waves, ArrowRight, CheckCircle, Map, Activity, Building, Cpu, Leaf } from "lucide-react"
            ...
            Array.from({ length: 3 }).map((_, index) => (
              <div key={index} className="bg-white rounded-2xl shadow-lg border border-slate-100 overflow-hidden animate-pulse">
                <div className="flex flex-col md:flex-row">
                  <div className="md:w-1/3 bg-slate-200 p-12 min-h-[200px]" />
            ...
            services?.map((service, index) => {
              ...
              return (
                <div 
                  key={service.id}
                  id={service.slug}
                  className="bg-white rounded-2xl shadow-lg border border-slate-100 overflow-hidden scroll-mt-24"
                >
