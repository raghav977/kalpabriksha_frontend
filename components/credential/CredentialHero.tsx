...
export function CredentialHero() {
  return (
    <section className="relative w-full h-[50vh] min-h-[350px] overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col justify-center items-center h-full px-6 text-center">
        ...
        <p className="text-lg md:text-xl text-gray-300 max-w-3xl leading-relaxed">
           Kalpabrikshya Engineering Solutions Pvt. Ltd. operates with complete regulatory compliance,
          rigorous documentation, and bankable governance structures for every hydropower project we lead.
        </p>
      </div>
